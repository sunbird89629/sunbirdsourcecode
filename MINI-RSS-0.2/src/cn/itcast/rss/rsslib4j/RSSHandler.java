...
public class RSSHandler extends DefaultHandler {
	...
	public static final String LAST_BUILD_DATE_TAG = "lastBuildDate";
	...
	public static final String CATEGORY_TAG = "category"; // TODO 对此节点的解析还没有加上。
	public static final String GUID_TAG = "guid";// TODO 对此节点的解析还没有加上。
	...
	private void processChannel(String qName, String data) {
		...
		if (tagIsEqual(qName, LAST_BUILD_DATE_TAG))
			chan.setPubDate(data);
